    ...
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                ...
                videoTemplateText:  '%text',
                graphTemplateText:  '%text',
        ...
        plugin.method = {
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                if (plugin.config.tryAgainText && plugin.config.tryAgainText !== '') {
                    $quizResultsCopy.append('<p><a class="btn btn-default ' + tryAgainClass + '" href="#">' + plugin.config.tryAgainText + '</a></p>');
                }
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        var videoQuestion = '';
                        if (plugin.config.displayQuestionNumber) {
                            videoQuestion = plugin.config.videoTemplateText
                                .replace('%count', count).replace('%text', question.v);
                        } else {
                        ...
                        if (plugin.config.backButtonText && plugin.config.backButtonText !== '') {
                            questionHTML.append('<a href="#" class="btn btn-default ' + backToQuestionClass + '">' + plugin.config.backButtonText + '</a>');
                        }
        ...
        plugin.init = function() {
            ...
            $(_element + ' ' + _nextQuestionBtn).on('click', function(e) {
                ...
                currentVideoTarget = "#video_question" + videoTargetPlus;
                nextVideoTarget = "#video_question" + videoTargetPlus;
